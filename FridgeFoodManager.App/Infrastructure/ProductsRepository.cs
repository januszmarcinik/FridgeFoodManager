...
namespace FridgeFoodManager.App.Infrastructure
{
    internal class ProductsRepository : IProductsRepository
    {
        ...
        internal void InitializeMockData()
        {
            ...
            {
                new Product { Id = Guid.NewGuid(), Name = "Mleko", ExpirationDate = startDate.AddDays(4), MaxDaysAfterOpening = 3 },
                new Product { Id = Guid.NewGuid(), Name = "Jajka", ExpirationDate = startDate.AddYears(1), MaxDaysAfterOpening = 60 },
                new Product { Id = Guid.NewGuid(), Name = "Jogurt", ExpirationDate = startDate.AddDays(-6), MaxDaysAfterOpening = 1 },
                new Product { Id = Guid.NewGuid(), Name = "Drożdże", ExpirationDate = startDate.AddDays(-10), MaxDaysAfterOpening = 15, RemovedAt = startDate.AddDays(-2) },
                ...
                new Product { Id = Guid.NewGuid(), Name = "Śmietana", ExpirationDate = startDate.AddDays(3), MaxDaysAfterOpening = 4, RemovedAt = startDate.AddDays(-9) }
            };
